...
def opt_obj(UEFC, AR, S):
    ...
    l_AR_initialGuess = 1.63 #from wing to tail
    l_AR_lowerBound = 0.5
    l_AR_upperBound = 3

    l_m_initialGuess = -0.17 #similar definition to l_AR but for the motor
    l_m_lowerBound = -0.5
    l_m_upperBound = 0
    ...
    bounds       = Bounds(lb=N_lowerBound, ub=N_upperBound, keep_feasible=True)
