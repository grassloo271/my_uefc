...
if __name__ == "__main__":
    ...
    aircraft.taper    = .45  # taper ratio
    aircraft.dihedral = 10  # Wing dihedral (degrees)
    aircraft.tau      = .1  # thickness-to-chord ratio

    # Tail parameters
    aircraft.Sh = .04 # Wing area of horizontal tail (m^2)
    aircraft.Sv = .03 # Wing area of vertical tail (m^2)
    aircraft.Sh = .04 # Wing area of horizontal tail (m^2)
    aircraft.Sv = .03 # Wing area of vertical tail (m^2)
    ...
    aircraft.CLdes = .75  # maximum CL wing will be designed to fly at (in cruise)
